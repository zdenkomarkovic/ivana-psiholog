...
export default function Newsletter() {
  ...
  return (
    <section className="py-16 md:py-16 bg-muted text-primary">
      <div className="max-w-[100rem] mx-auto px-4 md:px-8">
        <h2 className="text-3xl md:text-4xl font-thin italic text-background mb-4 text-left border-b border-background">
          Newsletter
        </h2>
        <p className="leading-relaxed mb-4  mx-auto">
        ...
        >
          <div className="grid md:grid-cols-3 md:gap-8">
            <input
              ...
              className="px-6 py-3 border-b-2 border-background bg-transparent  placeholder:text-background focus:outline-none focus:border-background/40 disabled:opacity-50"
            />
            <input
              type="email"
              value={email}
            ...
            >
              <span className="bg-background rounded-full px-8 py-0.5 hover:bg-background/80">
                {" "}
