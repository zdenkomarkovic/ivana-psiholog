...
export default function Footer() {
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-8 max-w-[100rem] ">
        <div className="grid md:grid-cols-3 gap-12 mb-8">
          <div>
            ...
            <p className="text-xl mt-3 border-t pt-3">
          ...
          <div>
            <h3 className="text-2xl font-bold mb-4 text-background text-left">
              Kontakt
            </h3>
